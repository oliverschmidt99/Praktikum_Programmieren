...
//---------------------------------------------------------------------------------------------------------------------------------
    case 0:
        rational *zahl_00 = creat(-1,12,24);
        break;
    case 1:
        rational *zahl_01 = creat(1,12,24);
        break;
    case 2:
        rational *zahl_02 = creat(-1,15,12);
        break;
    case 3: 
        rational *zahl_03 = creat(1,15,12);
        break;
//-----------------------------------------------------------------100000000er-----------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------------
    case 4:
        rational *zahl_04 = creat(-1,2495,8052);
        break;
    case 5:
        rational *zahl_05 = creat(1,2495,8052);
        break;
    case 6:
        rational *zahl_06 = creat(-1,9688,5038);
        break;
    case 7:
       rational *zahl_07 = creat(1,9688,5038);
        break; 
